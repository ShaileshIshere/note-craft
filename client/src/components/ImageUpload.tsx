    ...
    <div className="space-y-4">
      ...
      {!imagePreview && (
        <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-600 text-sm">Add an image URL above to preview your featured image</p>
          <p className="text-gray-500 text-xs mt-2">Supports JPG, PNG, GIF, and WebP formats</p>
        </div>
      )}
    </div>
  )
