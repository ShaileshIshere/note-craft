...
export const BlogCard = ({ id, authorName, publishedDate, title, content, imageUrl }: BlogCardProps) => {
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-12 py-6 sm:py-8 border-b border-gray-100 group-hover:border-gray-200 transition-colors duration-300">
            ...
            <div className="flex-1 space-y-3 sm:space-y-4 order-2 md:order-1">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-4">
                <Avatar size="small" name={authorName} imageUrl={getProfileImageUrl(authorName)} />
                <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs sm:text-sm">
                  ...
                  <Circle />
                  <span className="text-gray-500 capitalize">{publishedDate}</span>
                  <Circle />
...
export function Circle() {
  return <div className="h-1 w-1 rounded-full bg-gray-400 hidden sm:block"></div>
}
