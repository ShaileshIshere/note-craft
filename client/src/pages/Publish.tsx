        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Write Your Story</h1>
            </div>
        ...
        >
          <div className="p-6 sm:p-8 lg:p-12">
            ...
            <div className="pt-6 border-t border-gray-200">
              <PublishButton title={title} description={description} imageData={imageData} />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-2 text-sm text-blue-800">
            <li className="flex items-start gap-2">
              ...
              <span>Start with a compelling title that captures your main idea</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
            ...
            <li className="flex items-start gap-2">
              <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
              <span>Add a relevant image to make your article more engaging</span>
            </li>
          </ul>
        </motion.div>
      </div>
